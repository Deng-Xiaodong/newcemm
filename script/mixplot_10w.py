...
with open('data/cost_1000w.txt', 'r') as f:
...
#y_ticks = list(range(0, len(data_100w)+1, 1))  # 显示刻度位置
...
plt.xlabel("Dummy Quantity (×1000)", fontsize=12)
...
# 保存文件
plt.savefig('data/database_comparison_10w.png', bbox_inches='tight')
plt.close()
